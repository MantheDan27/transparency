...
function updateFilterCounts() {
  ...
  // Consolidate chained .filter().length calls into a single for...of loop with accumulator variables
  // to avoid redundant O(N) passes and intermediate array allocations.
  let fUnknownCount = 0;
