...
function updateFilterCounts() {
  ...
  // ⚡ Bolt Performance Optimization: Consolidate multiple filter passes into a single loop
  // This avoids 6 redundant O(N) array traversals and intermediate array allocations.
