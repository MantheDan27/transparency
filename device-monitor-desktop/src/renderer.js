...
function updateFilterCounts() {
  ...
  // ⚡ Bolt Performance Optimization: Consolidated multiple array filters into a single pass.
  // Instead of calling .filter().length multiple times, which creates intermediate arrays
  // and iterates O(N) multiple times, we loop once and tally all counts.
  let unknownCount = 0;
