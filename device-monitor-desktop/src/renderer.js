...
function updateFilterCounts() {
  ...
  // ⚡ Bolt Performance Optimization: Consolidated multiple .filter().length passes into a single O(N) loop to eliminate redundant iterations and intermediate array allocations.
