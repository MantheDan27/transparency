...
function updateFilterCounts() {
  ...
  // ⚡ Bolt Performance Optimization: Consolidated multiple O(N) .filter().length passes into a single O(N) loop to reduce array allocations and iteration overhead.
  let unknownCount = 0;
