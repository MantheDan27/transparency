...
function updateFilterCounts() {
  ...
  // Consolidated 6 separate O(N) array passes into a single O(N) pass to
  // calculate multiple UI statistics. This prevents redundant intermediate
  // array allocations and reduces main-thread blocking.
