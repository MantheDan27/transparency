...
function updateFilterCounts() {
  ...
  // ⚡ Bolt Performance Optimization: consolidate multiple chained .filter().length calls
  // into a single O(N) pass to avoid redundant iteration and intermediate array allocations
  let countUnknown = 0;
