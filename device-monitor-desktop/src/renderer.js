...
function updateFilterCounts() {
  ...
  // ⚡ Bolt Performance Optimization: Consolidate multiple .filter().length calls into a single O(N) pass to avoid redundant iterations and intermediate array allocations.
  let unknownCount = 0;
