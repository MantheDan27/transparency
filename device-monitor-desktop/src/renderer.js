...
function updateFilterCounts() {
  ...
  // ⚡ Bolt: Single O(N) pass to count all filter categories simultaneously
  // Reduces redundant array iterations and improves UI rendering latency for large device lists.
