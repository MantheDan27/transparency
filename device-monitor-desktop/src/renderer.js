...
function updateFilterCounts() {
  ...
  // ⚡ Bolt: Single pass O(N) over allDevices instead of 6 separate filter calls.
  // Optimizes CPU cycles and prevents main-thread blocking when rendering a large number of devices.
