...
function updateFilterCounts() {
  ...
  // ⚡ Bolt Performance Optimization: Consolidated multiple array.filter().length calls into a single O(N) pass to avoid redundant iterations and intermediate array allocations.
