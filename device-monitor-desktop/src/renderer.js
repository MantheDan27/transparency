...
function updateFilterCounts() {
  ...
  // Replaced multiple O(N) array .filter().length iterations with a single O(N) pass loop
  // using multiple counters to minimize UI rendering latency on large arrays.
