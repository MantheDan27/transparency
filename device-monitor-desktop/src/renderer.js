...
function updateFilterCounts() {
  ...
  // Replaced multiple chained `.filter().length` calls on `allDevices`
  // with a single `for...of` loop with accumulator variables to avoid redundant
  // O(N) passes and intermediate array allocations.
  let unknownCount = 0;
