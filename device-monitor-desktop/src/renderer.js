...
function updateFilterCounts() {
  ...
  // ⚡ Bolt Performance Optimization: Replaced multiple O(N) array .filter().length passes
  // with a single O(N) loop using accumulator variables to prevent main thread blocking.
  let unknownCount = 0;
