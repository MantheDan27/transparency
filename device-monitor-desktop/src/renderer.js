...
function updateFilterCounts() {
  ...
  // ⚡ Bolt Performance Optimization: Consolidated multiple O(N) array passes
  // and intermediate array allocations into a single O(N) loop.
  ...
  for (const d of allDevices) {
    ...
    if (trustState === 'unknown') unknownCount++;
    if (d.meta?.watchlist) watchlistCount++;
    if (trustState === 'owned') ownedCount++;
