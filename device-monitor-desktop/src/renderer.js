...
function updateFilterCounts() {
  ...
  // ⚡ Bolt: Single pass O(N) loop to calculate filter counts instead of 6 O(N) filter passes
  // Impact: Speeds up filter count calculation significantly by reducing array traversals
