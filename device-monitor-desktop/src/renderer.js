...
function updateFilterCounts() {
  ...
  // Consolidated multiple O(N) array filter allocations into a single O(N) pass
  // with accumulator variables to avoid redundant traversal and intermediate arrays.
  let unknownCount = 0, watchlistCount = 0, ownedCount = 0, riskyCount = 0, changedCount = 0, vmCount = 0;
