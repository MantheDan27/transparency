...
function updateFilterCounts() {
  ...
  // ⚡ Bolt Performance Optimization: Consolidate multiple chained .filter().length calls on the large allDevices array into a single pass to eliminate redundant O(N) allocations and loops.
  let unknownCount = 0;
