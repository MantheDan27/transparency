...
function updateFilterCounts() {
  ...
  // ⚡ Bolt Optimization: Replaced 6 O(N) array filter passes with a single O(N) loop
  // Expected impact: Reduces UI rendering latency when processing large device lists
