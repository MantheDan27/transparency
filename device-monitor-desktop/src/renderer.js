...
function updateFilterCounts() {
  ...
  // ⚡ Bolt: Single O(N) pass to count all filter categories instead of 6 separate .filter() passes
  // Impact: Reduces redundant iterations over large arrays by ~83% for UI updates
