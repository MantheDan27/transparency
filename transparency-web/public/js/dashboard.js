...
uploadForm.addEventListener("submit", async (e) => {
  ...
  try {
    ...
    // Replaced sequential await setDoc with Firestore writeBatch.
    // Groups up to 500 operations per API request to solve N+1 bottleneck,
    // massively reducing UI freezing and network overhead.
