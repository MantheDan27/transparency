...
## 2026-10-26 - [Concurrent Firestore Bulk Operations]
...
**Action:** Always batch related async DB updates into a single Promise.all concurrent execution rather than awaiting them individually within loops.
